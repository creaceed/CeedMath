...
c3inline vecn_x c3fx(vec3_min)(vec3_x res, const vec3_x a, const vec3_x b);
c3inline vecn_x c3fx(vec3_max)(vec3_x res, const vec3_x a, const vec3_x b);
c3inline vecn_x c3fx(vec3_step)(vec3_x res, const vec3_x edge, const vec3_x x);
c3inline vecn_x c3fx(vec3_smoothstep)(vec3_x res, const vec3_x edge1, const vec3_x edge2, const vec3_x x);
c3inline vecn_x c3fx(vec3_smoothhat)(vec3_x res, const vec3_x edge1, const vec3_x edge2, const vec3_x edge3, const vec3_x src);
